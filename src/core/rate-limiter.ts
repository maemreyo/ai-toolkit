...
export class RateLimiter {
   ...
   */
  async updateLimiter(id: string, newConfig: Partial<RateLimiterOptions>): Promise<void> {
   ...
   */
  private createSlidingWindowConfig(options: RateLimiterOptions): Bottleneck.ConstructorOptions {
   ...
   */
  private createFixedWindowConfig(options: RateLimiterOptions): Bottleneck.ConstructorOptions {
    const requestsPerMinute = options.requestsPerMinute || 60
   ...
   */
  private createTokenBucketConfig(options: RateLimiterOptions): Bottleneck.ConstructorOptions {
    const requestsPerMinute = options.requestsPerMinute || 60
   ...
   */
  private async getLimiterConfig(id: string): Promise<Partial<RateLimiterOptions>> {
